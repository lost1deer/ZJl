    ...
    <form action="<%=request.getContextPath() %>/Servlet.UpdateServlet" method="post">
        ...
        <tr>
            ...
            <td width="598px" height="53px">
                ...
                <input type="text" id="newslist" name="newslist" value="${param.newslist}"/>
        ...
        <tr>
            ...
            <td width="598px" height="53px">
                ...
                <input type="text" id="click" name="click" value="${param.click}" />
        ...
        <tr>
            ...
            <td width="598px" height="53px">
                ...
                <input type="text" id="updatetime" name="updatetime"value="${param.updatetime}" />
